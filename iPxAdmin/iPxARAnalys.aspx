<%@ Page Language="VB" MasterPageFile="~/iPxAdmin/MasterPage.master" AutoEventWireup="false" CodeFile="iPxARAnalys.aspx.vb" Inherits="iPxAdmin_iPxARAnalys" title="Alcor Accounting" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script>
        ...
        $.ajax({
            type: "POST",
            url: "iPxARAnalys.aspx/ChartAging",
...
//            console.log(data);
        ...
        $.ajax({
            type: "POST",
            url: "iPxARAnalys.aspx/ChartReceiptMtd",
            data: '{"dateAnalys": "' + document.getElementById("<%=tbDate.ClientID %>").value + '"}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
        ...
        $.ajax({
            type: "POST",
            url: "iPxARAnalys.aspx/ChartTransSix",
            data: '{"dateAnalys": "' + document.getElementById("<%=tbDate.ClientID %>").value + '"}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
...
//            console.log(data);
        ...
        $.ajax({
            type: "POST",
            url: "iPxARAnalys.aspx/ChartReceiptSix",
            data: '{"dateAnalys": "' + document.getElementById("<%=tbDate.ClientID %>").value + '"}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
