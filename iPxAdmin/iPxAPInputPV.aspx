<%@ Page Language="VB" MasterPageFile="~/iPxAdmin/MasterPage.master" AutoEventWireup="false" CodeFile="iPxAPInputPV.aspx.vb" Inherits="iPxAdmin_iPxAPInputPV" title="Alcor Accounting Input PV" %>
            ...
            <div class="modal-content">
                <div class="modal-header" style="background-color:Transparent;">
                    ...
                    <h4 id="login-modalLabel" class="modal-title">
                        AP Payment Voucher (PV) <asp:Label ID="lbInvID" runat="server" Text="InvoiceID"></asp:Label>
                    </h4>
                </div>
                ...
                <div class="modal-footer">
                    <asp:LinkButton ID="lbSaveInvoice" runat="server" CssClass="btn btn-default"><i class="fa fa-save"></i> Save Payment Voucher</asp:LinkButton>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-4">
            <div class="btn-group btn-group-justified">
                <asp:LinkButton ID="lbaddInvEdit" runat="server" CssClass="btn btn-default" Enabled="false" OnClientClick = "return ConfirmCreateInv();"><i class="fa fa-plus"></i> Add Voucher</asp:LinkButton>
            ...
            <asp:GridView EmptyDataText="No records has been added." ID="gvCustAR" runat="server" AutoGenerateColumns="false" CssClass="table" HeaderStyle-BackColor="#0a818e" HeaderStyle-ForeColor="White" HeaderStyle-Font-Bold="true" Font-Size="Smaller" GridLines="None" ShowFooter="true">
                <Columns>
                    <asp:BoundField DataField="VendorID" ItemStyle-Width="90px" HeaderText="Customer ID" />
            ...
            <div style="max-height:450px; overflow:auto;">
                <asp:GridView ID="gvInvoice" runat="server" DataKeyNames="RecID" AutoGenerateColumns="false" CssClass="table" FooterStyle-Font-Bold="true" HeaderStyle-BackColor="#0a818e" HeaderStyle-ForeColor="White" HeaderStyle-Font-Bold="true" Font-Size="Smaller" GridLines="None" ShowFooter="true">
                    <Columns>
                        ...
                        <asp:BoundField ItemStyle-Width ="120px" DataField="TransDate" HeaderText="Date" DataFormatString="{0:dd MMM yyyy}"/>
