...
Partial Class iPxAdmin_iPxInputCustomerAr
    ...
    Sub ARGroup()
        ...
        sSQL = "SELECT * FROM iPxAcctAR_Cfg_CustomerGrp where businessid = '" & Session("sBusinessID") & "' and isActive = 'Y' and arGroup <> 'CC'"
    ...
    Sub editCustAR()
        ...
        oSQLReader.Read()
        If oSQLReader.HasRows Then
            dlArgroup.SelectedValue = oSQLReader.Item("ARGroup").ToString
    ...
    Sub saveCustAR()
        ...
        sSQL += "VALUES ('" & Session("sBusinessID") & "','" & lbCustID.Text & "','" & dlArgroup.SelectedValue & "','" & dlCoyGroup.SelectedValue & "','" & Replace(tbCoyName.Text, "'", "''") & "','" & Replace(tbAddress.Text, "'", "''") & "'"
    ...
    Sub updateCustAR()
        ...
        End If
            Bank = ""
        sSQL = "UPDATE iPxAcctAR_Cfg_Customer SET arGroup='" & dlArgroup.SelectedValue & "',CoyGroup='" & dlCoyGroup.SelectedValue & "',CoyName='" & Replace(tbCoyName.Text, "'", "''") & "',Address='" & Replace(tbAddress.Text, "'", "''") & "',BilllingAddress='" & Replace(tbBilling.Text, "'", "''") & "',CountryId='" & dlCountry.SelectedValue & "',provid='" & dlProvince.SelectedValue & "',CityID='" & dlCity.SelectedValue & "',"
...
#Region "AR Group"
    Sub saveGroup()
        ...
        oCnct.Close()
        ScriptManager.RegisterStartupScript(Me, Me.GetType(), "alert", "alert('Add AR group successfully!');", True)
        ARGroup()
    ...
    Sub editGroup()
        ...
        sSQL += "WHERE businessid = '" & Session("sBusinessID") & "' and arGroup ='" & dlArgroup.SelectedValue & "'"
        oSQLCmd.CommandText = sSQL
        oSQLReader = oSQLCmd.ExecuteReader
    ...
    Sub updateGroup()
        ...
        oCnct.Close()
        ScriptManager.RegisterStartupScript(Me, Me.GetType(), "alert", "alert('AR group has been update !');", True)
        ScriptManager.RegisterStartupScript(Me, Me.GetType(), "hideModalAdd", "hideModalAdd()", True)
        ARGroup()
        lbAddAR.Text = "<i class='fa fa-plus' style='font-size:18px;'></i>"
    End Sub
...
#Region "Coy Group"
    ...
    Sub editCoyGroup()
        ...
        sSQL += "WHERE businessid = '" & Session("sBusinessID") & "' and CoyGroup ='" & dlCoyGroup.SelectedValue & "'"
        oSQLCmd.CommandText = sSQL
        oSQLReader = oSQLCmd.ExecuteReader
...
#End Region
    ...
    Protected Sub lbSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lbSave.Click
        ...
        End If
        If dlArgroup.Text = "" Then
            ScriptManager.RegisterStartupScript(Me, Me.GetType(), "alert", "alert('please Select AR Group!');", True)
            dlArgroup.Focus()
        ElseIf dlCoyGroup.Text = "" Then
        ...
        ElseIf pnCompany.Visible = True Then
            ...
            Else
                ...
                End If
                oSQLCmd = New SqlCommand(sSQL, oCnct)
                sSQL = "SELECT CustomerID FROM iPxAcctAR_Cfg_Customer WHERE CustomerID = '" & lbCustID.Text & "'"
                oSQLCmd.CommandText = sSQL
                oSQLReader = oSQLCmd.ExecuteReader
