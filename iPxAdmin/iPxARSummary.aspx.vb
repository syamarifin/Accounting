...
Partial Class iPxAdmin_iPxARSummary
    ...
    Sub clearSummary()
        ...
        sSQL = "DELETE FROM iPxAcctAR_Summary "
    ...
    Sub ListDetailSummaryCC()
        ...
        End If
        oSQLCmd = New SqlCommand(sSQL, oCnct)
        sSQL = "select a.businessid, 'AR OPEN' as TransID, '1900-01-01' as TransDate, '' as transactiontype, '' as invoiceno, '' as RoomNo, '' as GuestName, sum(a.amountcr) as Credit, sum(a.amountdr) as Debit from iPxAcctAR_Transaction as a "
        sSQL += "where a.businessid ='" & Session("sBusinessID") & "' and a.CustomerID='" & Session("sCustSummaryCC") & "' and (TransDate < '" & forDate & "01'  and a.isactive='Y') group by a.businessid "
        sSQL += "UNION ALL "
        sSQL += "select a.businessid, a.TransID, a.TransDate, a.transactiontype, a.invoiceno, a.RoomNo, a.GuestName, a.amountcr, a.amountdr from iPxAcctAR_Transaction as a "
        sSQL += "where a.businessid ='" & Session("sBusinessID") & "' and a.CustomerID='" & Session("sCustSummaryCC") & "' "
    ...
    Protected Sub gvSummary_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gvSummary.RowCommand
        If e.CommandName = "getDetail" Then
            ...
            lbTitleDetailCoa.Text = "Detail Summary Credit Card"
            Dim dateBirthday As Date = tbDate.Text
            forDate = dateBirthday.ToString("yyy-MM-")
            a = dateBirthday.ToString("yyy-MM-dd")
