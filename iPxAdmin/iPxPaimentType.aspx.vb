...
Partial Class iPxAdmin_iPxPaimentType
    ...
    Sub ListPaidBy()
        ...
        End If
        oSQLCmd = New SqlCommand(sSQL, oCnct)
        sSQL = "SELECT * FROM iPxAcctAR_Cfg_Paidby where businessid ='" & Session("sBusinessID") & "' and "
    ...
    Sub savepaidBy()
        ...
        sSQL = "INSERT INTO iPxAcctAR_Cfg_Paidby (businessid, PaidBy, Description, Coa,  isActive) "
    ...
    Sub updatePaidBy()
        ...
        ElseIf cbActive.Checked = False Then
            active = "N"
        End If
        sSQL = "UPDATE iPxAcctAR_Cfg_Paidby SET businessid='" & Session("sBusinessID") & "', Description='" & Replace(tbDescription.Text, "'", "''") & "'"
    ...
    Sub editPaidBy()
        ...
        End If
        oSQLCmd = New SqlCommand(sSQL, oCnct)
        sSQL = "SELECT * FROM iPxAcctAR_Cfg_Paidby "
    ...
    Protected Sub lbSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lbSave.Click
        ...
        Else
            ...
            End If
            oSQLCmd = New SqlCommand(sSQL, oCnct)
            sSQL = "SELECT PaidBy FROM iPxAcctAR_Cfg_Paidby WHERE businessid ='" & Session("sBusinessID") & "' and PaidBy = '" & tbPaid.Text & "' and isActive='Y'"
            oSQLCmd.CommandText = sSQL
            oSQLReader = oSQLCmd.ExecuteReader
