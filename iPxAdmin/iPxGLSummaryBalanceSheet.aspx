<%@ Page Language="VB" MasterPageFile="~/iPxAdmin/MasterPage.master" AutoEventWireup="false" CodeFile="iPxGLSummaryBalanceSheet.aspx.vb" Inherits="iPxAdmin_iPxGLSummaryBalanceSheet" title="Alcor Accounting" EnableEventValidation = "false"%>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <div id ="Div4" class="col-lg-3 col-xs-6 padding-info">
                            ...
                            <div class="small-box" style="background-color:White; margin-bottom:10px; border-top:3px solid #005662;">
                                <div class="small-box-header">
                                    <h3><asp:Label ID="Label5" runat="server" Text="Control Balance"></asp:Label></h3>
                                </div>
                                <div class="inner">
                                    <table style="width:100%">
                                        <tr>
    ...
    <div class="row">
        <div class="col-lg-12">
            <ul class="nav nav-tabs">
                ...
                <li id="Revenue-tab" class="hidden">    <a href="#Revenue" data-toggle="tab"><i class="fa fa-list"></i> Revenue</a></li>
                <li id="Cost-tab" class="hidden">       <a href="#Cost" data-toggle="tab"><i class="fa fa-list"></i> Cost</a></li>
                <li id="Expenses-tab" class="hidden">   <a href="#Expenses" data-toggle="tab"><i class="fa fa-list"></i> Expenses</a></li>
