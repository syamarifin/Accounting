<%@ Page Language="VB" MasterPageFile="~/iPxAdmin/MasterPage.master" AutoEventWireup="false" CodeFile="iPxARTransaction.aspx.vb" Inherits="iPxAdmin_iPxARTransaction" title="Alcor Accounting" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <div class="btn-group">
            <button type="button" style="width:150px;" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
