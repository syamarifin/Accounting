<%@ Page Language="VB" MasterPageFile="~/iPxAdmin/MasterPage.master" AutoEventWireup="false" CodeFile="iPxInputARTransaction.aspx.vb" Inherits="iPxAdmin_iPxInputARTransaction" title="Alcor Accounting" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div id="formDeleteTrans" tabindex="-1" role="dialog" aria-labelledby="login-modalLabel" aria-hidden="true" class="modal fade">
        <div role="document" class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header" style="background-color:Transparent;">
                    <h4 id="H2" class="modal-title">Delete Customer AR</h4>
                </div>
                <div class="modal-body">
                    Do you want to delete the AR transaction list ?.
                </div>
                <div class="modal-footer">
        ...
        <div role="document" class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header" style="background-color:Transparent;">
                    ...
                    <h4 id="login-modalLabel" class="modal-title">Find Customer AR</h4>
                </div>
                <div class="modal-body">
        ...
        <div role="document" class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header" style="background-color:Transparent;">
                    ...
                    <h4 id="H1" class="modal-title">Form AR Transaction</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group" style="margin-bottom:3px;">
                                <label for="usr">Customer:</label><font color=red>*</font>
                                <div class="input-group">
                            ...
                            <div class="form-group" style="margin-bottom:3px;">
                                ...
                                <asp:TextBox ID="tbVoucher" runat="server" CssClass ="form-control"></asp:TextBox>
                            </div>
                            <div class="form-group" style="margin-bottom:3px;">
                                <label for="usr">Folio No:</label>
                                <asp:TextBox ID="tbFolio" runat="server" CssClass ="form-control"></asp:TextBox>
                            </div>
                            <div class="form-group" style="margin-bottom:3px;">
                                <label for="usr">Reservation No:</label>
                                <asp:TextBox ID="tbRsvdNo" runat="server" CssClass ="form-control"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group" style="margin-bottom:3px;">
                                <label for="usr">Guest Name:</label>
                                <asp:TextBox ID="tbGuest" runat="server" CssClass ="form-control"></asp:TextBox>
                            </div>
                            <div class="form-group" style="margin-bottom:3px;">
                                <label for="usr">Room No:</label>
                                <asp:TextBox ID="tbRoom" runat="server" CssClass ="form-control"></asp:TextBox>
                            </div>
                            <div class="form-group" style="margin-bottom:3px;">
                                <label for="usr">Arrival:</label>
    ...
    <div class="small-box">
        <div class="inner">
            <h3>AR Transaction <asp:Label ID="lbTransID" runat="server" Text="TransID"></asp:Label></h3>
            ...
            HeaderStyle-ForeColor="White" HeaderStyle-Font-Bold="true" Font-Size="Smaller" GridLines="None" AllowPaging="true" PageSize="10" ShowFooter="true">
                <Columns>
                    ...
                    <asp:BoundField ItemStyle-Width ="85px" DataField="arrival" HeaderText="Arrival" DataFormatString="{0:dd MMM yyyy}"/>
                    <asp:BoundField ItemStyle-Width ="85px" DataField="departure" HeaderText="Departure" DataFormatString="{0:dd MMM yyyy}"/>
                    ...
                    <asp:BoundField ItemStyle-Width ="80px" DataField="GuestName" HeaderText="Guest Name" />
                    <asp:BoundField ItemStyle-Width ="80px" DataField="invoiceno" HeaderText="Invoice No" />
                    <asp:TemplateField HeaderText="Amount" HeaderStyle-CssClass="header-right" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="80px">
                        <ItemTemplate>
                            <asp:Label ID="lblOpen" runat="server" Text='<%# if(Eval("amountdr").toString()="","0.00",Eval("amountdr","{0:N2}")) %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="notes" HeaderText="Notes" />
                    <asp:TemplateField ItemStyle-Width="50px" HeaderText="Edit" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:LinkButton ID="lbEdit" CssClass="btn btn-default" runat="server" CommandName="getEdit" CommandArgument='<%# Eval("RecID")%>' Enabled='<%# if(Session("sStatusARTrans")<>"N","false",if(Trim(Eval("invoiceno").toString())="",if(Eval("edit").toString()="Y",if(Eval("CloseStatus").toString()="Close","false","true"),"false"),"false"))%>'><i class="fa fa-edit"></i></asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField ItemStyle-Width="50px" HeaderText="Delete" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:LinkButton ID="LinkButton1" CssClass="btn btn-default" runat="server" CommandName="getDelete" CommandArgument='<%# Eval("RecID")%>' Enabled='<%# if(Session("sStatusARTrans")<>"N","false",if(Trim(Eval("invoiceno").toString())="",if(Eval("deleteAR").toString()="Y",if(Eval("CloseStatus").toString()="Close","false","true"),"false"),"false"))%>'><i class="fa fa-trash"></i></asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
                <pagerstyle cssclass="pagination-ys">
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <div id="footer" class="container" >
        <a class="collapsed btn btn-default" style="width:120px;" role="button" href="iPxARTransaction.aspx"> <i class="fa fa-close"></i> Abort </a>
