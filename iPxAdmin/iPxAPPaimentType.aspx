<%@ Page Language="VB" MasterPageFile="~/iPxAdmin/MasterPage.master" AutoEventWireup="false" CodeFile="iPxAPPaimentType.aspx.vb" Inherits="iPxAdmin_iPxAPPaimentType" title="Alcor Accounting" %>
        ...
        <div role="document" class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header" style="background-color:Transparent;">
                    ...
                    <h4 id="login-modalLabel" class="modal-title">Form AP Payment</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-12">
        ...
        <div role="document" class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header" style="background-color:Transparent;">
                    ...
                    <h4 id="H1" class="modal-title">Query AP Payment</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-12">
