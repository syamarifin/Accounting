<%@ Page Language="VB" MasterPageFile="~/iPxAdmin/MasterPage.master" AutoEventWireup="false" CodeFile="iPxInputCustomerAr.aspx.vb" Inherits="iPxAdmin_iPxInputCustomerAr" title="Alcor Accounting" %>
    ...
    <div id="accordion" class="checkout">
        <div class="panel checkout-step">
            <div> <span class="checkout-step-number">1</span>
                <h4 class="checkout-step-title"> <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" > AR Customer 
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group" style="margin-bottom:3px;">
                                            <label for="usr">AR Group:</label><font color=red>*</font>
                                            <div class="input-group">
        ...
        <div class="panel checkout-step">
            <div role="tab" id="headingTwo"> <span class="checkout-step-number">2</span>
                <h4 class="checkout-step-title"> <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" > Customer Address </a> </h4>
            </div>
        ...
        <div class="panel checkout-step">
            ...
            <div id="collapseFour" class="panel-collapse collapse">
                <div class="checkout-step-body">
                    ...
                    <asp:LinkButton ID="lbMoveAR" runat="server" CssClass="btn btn-link"> Select AR Group </asp:LinkButton>
                    </asp:Panel>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group" style="margin-bottom:3px;">
                                ...
                                <asp:DropDownList ID="dlFOName" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="dlFOName_SelectedIndexChanged">
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group" style="margin-bottom:3px;">
                                <label for="usr">Company/Agent:</label>
                                <asp:DropDownList ID="dlProfileCode" runat="server" CssClass="form-control">
                                </asp:DropDownList>
                            </div>
                        </div>
                    </div>
