...
Partial Class iPxAdmin_iPxAPVendorGrp
    ...
    Sub showdata_dropdownCustStatus()
        ...
        dlStatus.Items.Insert(1, "All Vendor")
        dlStatus.Items.Insert(2, "Non Vendor")
        dlStatus.Items.Insert(3, "Vendor")
    End Sub
    Sub ListGrup()
        ...
        sSQL = "SELECT * FROM iPxAcctAP_Cfg_VendorGrp where businessid ='" & Session("sBusinessID") & "' and "
    ...
    Sub editGroup()
        ...
        End If
        oSQLCmd = New SqlCommand(sSQL, oCnct)
        sSQL = "SELECT * FROM iPxAcctAP_Cfg_VendorGrp "
        sSQL += "WHERE apGroup ='" & Session("sBiEdit") & "'"
        oSQLCmd.CommandText = sSQL
    ...
    Sub updateGroup()
        ...
        ElseIf cbActive.Checked = False Then
            active = "N"
        End If
        sSQL = "UPDATE iPxAcctAP_Cfg_VendorGrp SET Description='" & Replace(tbDescription.Text, "'", "''") & "', isActive='" & active & "'"
        sSQL = sSQL & "WHERE businessid='" & Session("sBusinessID") & "' and apGroup ='" & Session("sBiEdit") & "'"
    ...
    Protected Sub lblQuery_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lblQuery.Click
        ...
        If tbQArGroup.Text.Trim <> "" Then
            Session("sCondition") = Session("sCondition") & " and (apGroup like '%" & Replace(tbQArGroup.Text.Trim, "'", "''") & "%') "
        End If
