<%@ Page Language="VB" MasterPageFile="~/iPxAdmin/MasterPage.master" AutoEventWireup="false" CodeFile="iPxARReceipt.aspx.vb" Inherits="iPxAdmin_iPxARReceipt" title="Alcor Accounting" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <div role="document" class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header" style="background-color:Transparent;">
                    ...
                    <h4 id="H2" class="modal-title">Do you want to delete Receipt ?</h4>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label for="usr">Reason to delete AR receipt :</label><font color=red>*</font>
        ...
        <div role="document" class="modal-dialog modal-sm" style="width:400px;">
            <div class="modal-content">
                <div class="modal-header" style="background-color:Transparent;">
                    ...
                    <h4 id="H1" class="modal-title">Query Receipt Customer</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <asp:Panel ID="pnRecept" runat="server">
                                <div class="form-group">
                                    <label for="usr">Receipt ID:</label>
                            ...
                            <asp:Panel ID="pnCust" runat="server">
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="dlQCoyGroup" runat="server" CssClass="form-control">
                                    </asp:DropDownList>
                                </div>
                                <div class="form-group">
    ...
    <div class="row">
        <div class="col-lg-8">
            <asp:LinkButton ID="lbAddRec" Width="150px" runat="server" CssClass="btn btn-default"><i class="fa fa-plus"></i> New Receipt</asp:LinkButton>
            <asp:LinkButton ID="lbView" Width="150px" runat="server" CssClass="btn btn-default" Visible="false"><i class="fa fa-file-text-o"></i> View Receipt</asp:LinkButton>
        ...
        <div class="col-lg-12">
            ...
            <asp:GridView EmptyDataText="No records has been added." ID="gvARRec" runat="server" AutoGenerateColumns="false" CssClass="table" HeaderStyle-BackColor="#0a818e" HeaderStyle-ForeColor="White" HeaderStyle-Font-Bold="true" Font-Size="Smaller" GridLines="None" AllowPaging="true" PageSize="10" ShowFooter="true">
                <Columns>
                    <asp:BoundField ItemStyle-Width="100px" DataField="ReceiptID" HeaderText="Receipt No" />
                    <asp:BoundField ItemStyle-Width="100px" DataField="ReceiptDate" HeaderText="Date" DataFormatString="{0:dd MMM yyyy}"/>
                    <asp:BoundField ItemStyle-Width="100px" DataField="CoyName" HeaderText="Customer Name" />
                    <asp:BoundField ItemStyle-Width="100px" DataField="ReffNo" HeaderText="Reff No" />
                    ...
                    <asp:TemplateField ItemStyle-Width="40px" HeaderText="Saldo Balance" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:LinkButton ID="lbDep" CssClass="btn btn-default" runat="server" CommandName="getDeposito" CommandArgument='<%# Eval("ReceiptID") %>'><i class="fa fa-file-text"></i></asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField ItemStyle-Width="40px" HeaderText="Post" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:LinkButton ID="lbPost" CssClass="btn btn-default" runat="server" CommandName="getPosting" CommandArgument='<%# Eval("ReceiptID") %>' OnClientClick="return confirmationPost();" Enabled='<%# if(Eval("status").toString()="N",if(Eval("postRec").toString()="Y","true","false"),"false") %>'><i class="fa fa-send"></i></asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField ItemStyle-Width="40px" HeaderText="Print" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:LinkButton ID="lbPrint" CssClass="btn btn-default" runat="server" CommandName="getPrint" CommandArgument='<%# Eval("ReceiptID") %>'><i class="fa fa-print"></i></asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                        ...
                        <ItemTemplate>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu" style="left:-60px; min-width: 100px;" role="menu">
                                    <li><asp:LinkButton ID="lbDetail" CssClass="btn btn-link btn_right" runat="server" CommandName="getDetail" CommandArgument='<%# Eval("ReceiptID") %>'> Detail <i class="fa fa-file-text-o"></i> </asp:LinkButton></li>
                                    <li><asp:LinkButton ID="lbEdit" CssClass="btn btn-link btn_right" runat="server" CommandName="getEdit" CommandArgument='<%# Eval("ReceiptID") %>' Enabled='<%# if(Eval("editRec").toString()="Y","true","false") %>'> Edit <i class="fa fa-edit"></i></asp:LinkButton></li>
                                    <li><asp:LinkButton ID="lbDelete" CssClass="btn btn-link btn_right" runat="server" CommandName="getDelete" Enabled='<%# if(Eval("status").toString()<>"N","false",if(Eval("deleteRec").toString()="Y","true","false")) %>' CommandArgument='<%# Eval("ReceiptID") %>'> Delete <i class="fa fa-trash"></i></asp:LinkButton></li>
                                </ul>
                            </div>
                        </ItemTemplate>
                    </asp:TemplateField>
