<%@ Page Language="VB" MasterPageFile="~/iPxAdmin/MasterPage.master" AutoEventWireup="false" CodeFile="iPxCustomerGrp.aspx.vb" Inherits="iPxAdmin_iPxCustomerGrp" title="Alcor Accounting" %>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="tbQBusinessId" runat="server" CssClass ="form-control"></asp:TextBox>
                    </div>
                    <div class="form-group">
        ...
        <div class="col-lg-12">
            <asp:GridView EmptyDataText="No records has been added." ID="gvGrup" runat="server" AutoGenerateColumns="false" CssClass="table" HeaderStyle-BackColor="#0a818e" HeaderStyle-ForeColor="White" HeaderStyle-Font-Bold="true" Font-Size="Smaller" GridLines="None" AllowPaging="true" PageSize="10">
                <Columns>
                    ...
                    <asp:BoundField ItemStyle-Width="200px" DataField="arGroup" HeaderText="AR Group" />
                    <asp:BoundField DataField="Description" HeaderText="Description" />
                    <asp:TemplateField ItemStyle-Width="70px" HeaderText="Edit" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:LinkButton ID="lbEdit" CssClass="btn btn-default" runat="server" CommandName="getEdit" Enabled='<%# if(Eval("arGroup").ToString() = "CC", "False", "True") %>' CommandArgument='<%# Eval("arGroup") %>'><i class="fa fa-edit"></i></asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
