...
Partial Class iPxAdmin_iPxGLSummaryBalanceSheet
    ...
    Sub show_Group()
        dlGroup.Items.Clear()
        dlGroup.Items.Insert(0, "Balance Sheet")
    End Sub
    'Sub ExportExcel()
...
#Region "Detail Coa"
    Sub listDetailCOAAsset()
        ...
        sSQL += "WHERE a.businessid='" & Session("sBusinessID") & "' and MONTH(a.TransDate)='" & forMonth & "' and year(a.TransDate)='" & forYear & "' "
...
#End Region
    ...
    Protected Sub lbPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lbPrint.Click
        Session("sReport") = "GLSummaryBalance"
        If dlGroup.SelectedIndex = 0 Then
            Session("sMapPath") = "~/iPxReportFile/dckGL_BalanceSheet.rpt"
