...
Partial Class iPxAdmin_iPxAPAging
    ...
    Sub listAging()
        ...
        sSQL = "select a.VendorID, (c.Description) as apGroup, CoyName, (SELECT (SUM(iPxAcctAP_Transaction.amountcr) -SUM(iPxAcctAP_Transaction.amountdr)) AS 'amount' "
        sSQL += "FROM iPxAcctAP_Transaction where businessid ='" & Session("sBusinessID") & "' and VendorID = a.VendorID and (TransDate <= '" & a & "') and isActive='Y' group by VendorID) as balance, "
        ...
        sSQL += "FROM iPxAcctAP_Transaction where businessid ='" & Session("sBusinessID") & "' and PVno ='' and VendorID = a.VendorID and (TransDate > '" & bln1 & "') and (TransDate <= '" & a & "') and isActive='Y' "
        sSQL += "group by VendorID UNION ALL "
        sSQL += "SELECT iPxAcctAP_Transaction.VendorID,(SUM(iPxAcctAP_Transaction.amountcr) -SUM(CASE WHEN iPxAcctAP_Transaction.TransDate <= '" & a & "' THEN iPxAcctAP_Transaction.amountdr WHEN iPxAcctAP_Transaction.TransDate > '" & a & "' THEN '0' END)) AS 'amount' "
        sSQL += "FROM iPxAcctAP_PV inner join iPxAcctAP_Transaction on iPxAcctAP_Transaction.PVno=iPxAcctAP_PV.PVNo "
        sSQL += "where iPxAcctAP_Transaction.businessid ='" & Session("sBusinessID") & "' and iPxAcctAP_Transaction.PVno <> '' and iPxAcctAP_Transaction.VendorID = a.VendorID and iPxAcctAP_Transaction.isActive='Y' and "
        sSQL += "(CASE WHEN iPxAcctAP_PV.PVDate < '" & a & "' THEN iPxAcctAP_PV.PVDate WHEN iPxAcctAP_PV.PVDate >= '" & a & "' THEN iPxAcctAP_Transaction.TransDate END > '" & bln1 & "') and "
        sSQL += "(CASE WHEN iPxAcctAP_PV.PVDate < '" & a & "' THEN iPxAcctAP_PV.PVDate WHEN iPxAcctAP_PV.PVDate >= '" & a & "' THEN iPxAcctAP_Transaction.TransDate END <= '" & a & "') "
        sSQL += "group by iPxAcctAP_Transaction.VendorID) a GROUP BY VendorID)as bulan1, "
        sSQL += "(SELECT SUM(amount) FROM (SELECT VendorID,(SUM(iPxAcctAP_Transaction.amountcr) -SUM(iPxAcctAP_Transaction.amountdr)) AS 'amount' "
        sSQL += "FROM iPxAcctAP_Transaction where businessid ='" & Session("sBusinessID") & "' and PVno ='' and VendorID = a.VendorID and (TransDate > '" & bln2 & "') and (TransDate <= '" & bln1 & "') and isActive='Y' "
        sSQL += "group by VendorID UNION ALL "
        sSQL += "SELECT iPxAcctAP_Transaction.VendorID,(SUM(iPxAcctAP_Transaction.amountcr) -SUM(CASE WHEN iPxAcctAP_Transaction.TransDate <= '" & a & "' THEN iPxAcctAP_Transaction.amountdr WHEN iPxAcctAP_Transaction.TransDate > '" & a & "' THEN '0' END)) AS 'amount' "
        sSQL += "FROM iPxAcctAP_PV inner join iPxAcctAP_Transaction on iPxAcctAP_Transaction.PVno=iPxAcctAP_PV.PVNo "
        sSQL += "where iPxAcctAP_Transaction.businessid ='" & Session("sBusinessID") & "' and iPxAcctAP_Transaction.PVno <> '' and iPxAcctAP_Transaction.VendorID = a.VendorID and iPxAcctAP_Transaction.isActive='Y' and "
        sSQL += "(CASE WHEN iPxAcctAP_PV.PVDate < '" & a & "' THEN iPxAcctAP_PV.PVDate WHEN iPxAcctAP_PV.PVDate >= '" & a & "' THEN iPxAcctAP_Transaction.TransDate END > '" & bln2 & "') and "
        sSQL += "(CASE WHEN iPxAcctAP_PV.PVDate < '" & a & "' THEN iPxAcctAP_PV.PVDate WHEN iPxAcctAP_PV.PVDate >= '" & a & "' THEN iPxAcctAP_Transaction.TransDate END <= '" & bln1 & "') "
        sSQL += "group by iPxAcctAP_Transaction.VendorID) a GROUP BY VendorID)as bulan2, "
        sSQL += "(SELECT SUM(amount) FROM (SELECT VendorID,(SUM(iPxAcctAP_Transaction.amountcr) -SUM(iPxAcctAP_Transaction.amountdr)) AS 'amount' "
        sSQL += "FROM iPxAcctAP_Transaction where businessid ='" & Session("sBusinessID") & "' and PVno ='' and VendorID = a.VendorID and (TransDate > '" & bln3 & "') and (TransDate <= '" & bln2 & "') and isActive='Y' "
        sSQL += "group by VendorID UNION ALL "
        sSQL += "SELECT iPxAcctAP_Transaction.VendorID,(SUM(iPxAcctAP_Transaction.amountcr) -SUM(CASE WHEN iPxAcctAP_Transaction.TransDate <= '" & a & "' THEN iPxAcctAP_Transaction.amountdr WHEN iPxAcctAP_Transaction.TransDate > '" & a & "' THEN '0' END)) AS 'amount' "
        sSQL += "FROM iPxAcctAP_PV inner join iPxAcctAP_Transaction on iPxAcctAP_Transaction.PVno=iPxAcctAP_PV.PVNo "
        sSQL += "where iPxAcctAP_Transaction.businessid ='" & Session("sBusinessID") & "' and iPxAcctAP_Transaction.PVno <> '' and iPxAcctAP_Transaction.VendorID = a.VendorID and iPxAcctAP_Transaction.isActive='Y' and "
        sSQL += "(CASE WHEN iPxAcctAP_PV.PVDate < '" & a & "' THEN iPxAcctAP_PV.PVDate WHEN iPxAcctAP_PV.PVDate >= '" & a & "' THEN iPxAcctAP_Transaction.TransDate END > '" & bln3 & "') and "
        sSQL += "(CASE WHEN iPxAcctAP_PV.PVDate < '" & a & "' THEN iPxAcctAP_PV.PVDate WHEN iPxAcctAP_PV.PVDate >= '" & a & "' THEN iPxAcctAP_Transaction.TransDate END <= '" & bln2 & "') "
        sSQL += "group by iPxAcctAP_Transaction.VendorID) a GROUP BY VendorID)as bulan3, "
        sSQL += "(SELECT SUM(amount) FROM (SELECT VendorID,(SUM(iPxAcctAP_Transaction.amountcr) -SUM(iPxAcctAP_Transaction.amountdr)) AS 'amount' "
        sSQL += "FROM iPxAcctAp_Transaction where businessid ='" & Session("sBusinessID") & "' and PVno ='' and VendorID = a.VendorID and (TransDate > '" & bln4 & "') and (TransDate <= '" & bln3 & "') and isActive='Y' "
        sSQL += "group by VendorID UNION ALL "
        sSQL += "SELECT iPxAcctAP_Transaction.VendorID,(SUM(iPxAcctAP_Transaction.amountcr) -SUM(CASE WHEN iPxAcctAP_Transaction.TransDate <= '" & a & "' THEN iPxAcctAP_Transaction.amountdr WHEN iPxAcctAP_Transaction.TransDate > '" & a & "' THEN '0' END)) AS 'amount' "
        sSQL += "FROM iPxAcctAP_PV inner join iPxAcctAP_Transaction on iPxAcctAP_Transaction.PVno=iPxAcctAP_PV.PVNo "
        sSQL += "where iPxAcctAP_Transaction.businessid ='" & Session("sBusinessID") & "' and iPxAcctAP_Transaction.PVno <> '' and iPxAcctAP_Transaction.VendorID = a.VendorID and iPxAcctAP_Transaction.isActive='Y' and "
        sSQL += "(CASE WHEN iPxAcctAP_PV.PVDate < '" & a & "' THEN iPxAcctAP_PV.PVDate WHEN iPxAcctAP_PV.PVDate >= '" & a & "' THEN iPxAcctAP_Transaction.TransDate END > '" & bln4 & "') and "
        sSQL += "(CASE WHEN iPxAcctAP_PV.PVDate < '" & a & "' THEN iPxAcctAP_PV.PVDate WHEN iPxAcctAP_PV.PVDate >= '" & a & "' THEN iPxAcctAP_Transaction.TransDate END <= '" & bln3 & "') "
        sSQL += "group by iPxAcctAP_Transaction.VendorID) a GROUP BY VendorID)as bulan4, "
        sSQL += "(SELECT SUM(amount) FROM (SELECT VendorID,(SUM(iPxAcctAP_Transaction.amountcr) -SUM(iPxAcctAP_Transaction.amountdr)) AS 'amount' "
        sSQL += "FROM iPxAcctAP_Transaction where businessid ='" & Session("sBusinessID") & "' and PVno ='' and VendorID = a.VendorID and (TransDate <= '" & bln4 & "') and isActive='Y' "
        sSQL += "group by VendorID UNION ALL "
        sSQL += "SELECT iPxAcctAP_Transaction.VendorID,(SUM(iPxAcctAP_Transaction.amountcr) -SUM(CASE WHEN iPxAcctAP_Transaction.TransDate <= '" & a & "' THEN iPxAcctAP_Transaction.amountdr WHEN iPxAcctAP_Transaction.TransDate > '" & a & "' THEN '0' END)) AS 'amount' "
        sSQL += "FROM iPxAcctAP_PV inner join iPxAcctAP_Transaction on iPxAcctAP_Transaction.PVno=iPxAcctAP_PV.PVNo "
        sSQL += "where iPxAcctAP_Transaction.businessid ='" & Session("sBusinessID") & "' and iPxAcctAP_Transaction.PVno <> '' and iPxAcctAP_Transaction.VendorID = a.VendorID and iPxAcctAP_Transaction.isActive='Y' and "
        sSQL += "(CASE WHEN iPxAcctAP_PV.PVDate < '" & a & "' THEN iPxAcctAP_PV.PVDate WHEN iPxAcctAP_PV.PVDate >= '" & a & "' THEN iPxAcctAP_Transaction.TransDate END <= '" & bln4 & "') "
        sSQL += "group by iPxAcctAP_Transaction.VendorID) a GROUP BY VendorID)as lbh "
        ...
        sSQL += "(SELECT SUM(amount) FROM (SELECT VendorID,(SUM(iPxAcctAP_Transaction.amountcr) -SUM(iPxAcctAP_Transaction.amountdr)) AS 'amount' "
        sSQL += "FROM iPxAcctAP_Transaction where businessid ='" & Session("sBusinessID") & "' and PVno ='' and VendorID = a.VendorID and (TransDate <= '" & a & "') and isActive='Y' group by VendorID UNION ALL "
        sSQL += "SELECT iPxAcctAP_Transaction.VendorID,(SUM(iPxAcctAP_Transaction.amountcr) -SUM(CASE WHEN iPxAcctAP_Transaction.TransDate <= '" & a & "' THEN iPxAcctAP_Transaction.amountdr WHEN iPxAcctAP_Transaction.TransDate > '" & a & "' THEN '0' END)) AS 'amount' "
        sSQL += "FROM iPxAcctAP_PV inner join iPxAcctAP_Transaction on iPxAcctAP_Transaction.businessid=iPxAcctAP_PV.businessid and iPxAcctAP_Transaction.PVno=iPxAcctAP_PV.PVNo "
        ...
        sSQL += "and (iPxAcctAP_Transaction.TransDate <= '" & a & "') group by iPxAcctAp_Transaction.VendorID) a GROUP BY VendorID) <>'' "
    ...
    Sub clearAging()
        ...
        sSQL = "DELETE FROM iPxAcctAP_Aging "
    ...
    Sub CreatAging()
        ...
        End If
        oSQLCmd = New SqlCommand(sSQL, oCnct)
        sSQL = "INSERT INTO iPxAcctAP_Aging (businessid,RegBy,VendorID,balance,bln1,bln2,bln3,bln4,other) "
        sSQL += "select a.businessid, '" & Session("sUserCode") & "', a.VendorID, (SELECT (SUM(iPxAcctAP_Transaction.amountcr) -SUM(iPxAcctAP_Transaction.amountdr)) AS 'amount' "
        sSQL += "FROM iPxAcctAP_Transaction where businessid ='" & Session("sBusinessID") & "' and VendorID = a.VendorID and (TransDate <= '" & a & "') and isActive='Y' group by VendorID) as balance, "
        sSQL += "(SELECT SUM(amount) FROM (SELECT VendorID,(SUM(iPxAcctAP_Transaction.amountcr) -SUM(iPxAcctAP_Transaction.amountdr)) AS 'amount' "
        sSQL += "FROM iPxAcctAP_Transaction where businessid ='" & Session("sBusinessID") & "' and PVno ='' and VendorID = a.VendorID and (TransDate > '" & bln1 & "') and (TransDate <= '" & a & "') and isActive='Y' "
        sSQL += "group by VendorID UNION ALL "
    ...
    Sub clearAgingSub()
        ...
        sSQL = "DELETE FROM iPxAcctAP_AgingSub "
        sSQL = sSQL & "WHERE businessid='" & Session("sBusinessID") & "' and VendorID='" & Session("sCustSummaryCC") & "'"
    ...
    Sub CreatAgingSub()
        ...
        End If
        oSQLCmd = New SqlCommand(sSQL, oCnct)
        sSQL = "INSERT INTO iPxAcctAP_AgingSub(businessid,VendorID,aging,TransID,TransDate,transactiontype,PVno,RoomNo,GuestName,amountdr,amountcr) "
        sSQL += "SELECT iPxAcctAP_Transaction.businessid,iPxAcctAP_Transaction.VendorID, '1 - 30 Days' as aging, iPxAcctAP_Transaction.TransID, iPxAcctAP_Transaction.TransDate,iPxAcctAP_Transaction.transactiontype, iPxAcctAP_Transaction.PVno, iPxAcctAP_Transaction.PONo, iPxAcctAP_Transaction.RRNo, (iPxAcctAP_Transaction.amountdr) ,(iPxAcctAP_Transaction.amountcr) "
        sSQL += "FROM iPxAcctAP_Transaction where businessid ='" & Session("sBusinessID") & "' and PVno ='' and VendorID = '" & Session("sCustSummaryCC") & "' and (TransDate > '" & bln1 & "') and (TransDate <= '" & a & "') and isActive='Y' "
        sSQL += "UNION ALL "
        sSQL += "SELECT iPxAcctAP_Transaction.businessid,iPxAcctAP_Transaction.VendorID, '1 - 30 Days' as aging, iPxAcctAP_Transaction.TransID, iPxAcctAP_Transaction.TransDate,iPxAcctAP_Transaction.transactiontype, iPxAcctAP_Transaction.PVno, iPxAcctAP_Transaction.PONo, iPxAcctAP_Transaction.RRNo, (iPxAcctAP_Transaction.amountdr) ,(CASE WHEN iPxAcctAP_Transaction.TransDate <= '" & a & "' THEN iPxAcctAP_Transaction.amountcr WHEN iPxAcctAP_Transaction.TransDate > '" & a & "' THEN '0' END) "
        sSQL += "FROM iPxAcctAP_PV inner join iPxAcctAP_Transaction on iPxAcctAP_Transaction.PVno=iPxAcctAP_PV.PVNo "
        sSQL += "where iPxAcctAP_Transaction.businessid ='" & Session("sBusinessID") & "' and iPxAcctAP_Transaction.PVno <> '' and iPxAcctAP_Transaction.VendorID = '" & Session("sCustSummaryCC") & "' and iPxAcctAP_Transaction.isActive='Y' and "
        sSQL += "(CASE WHEN iPxAcctAP_PV.PVDate < '" & a & "' THEN iPxAcctAP_PV.PVDate WHEN iPxAcctAP_PV.PVDate >= '" & a & "' THEN iPxAcctAP_Transaction.TransDate END > '" & bln1 & "') and "
        sSQL += "(CASE WHEN iPxAcctAP_PV.PVDate < '" & a & "' THEN iPxAcctAP_PV.PVDate WHEN iPxAcctAP_PV.PVDate >= '" & a & "' THEN iPxAcctAP_Transaction.TransDate END <= '" & a & "') "
        sSQL += "UNION ALL "
        sSQL += "SELECT iPxAcctAP_Transaction.businessid,iPxAcctAP_Transaction.VendorID, '31 - 60 Days' as aging, iPxAcctAP_Transaction.TransID, iPxAcctAP_Transaction.TransDate,iPxAcctAP_Transaction.transactiontype, iPxAcctAP_Transaction.PVno, iPxAcctAP_Transaction.PONo, iPxAcctAP_Transaction.RRNo, (iPxAcctAP_Transaction.amountdr) ,(iPxAcctAP_Transaction.amountcr) "
        sSQL += "FROM iPxAcctAP_Transaction where businessid ='" & Session("sBusinessID") & "' and PVno ='' and VendorID = '" & Session("sCustSummaryCC") & "' and (TransDate > '" & bln2 & "') and (TransDate <= '" & bln1 & "') and isActive='Y' "
        sSQL += "UNION ALL "
        sSQL += "SELECT iPxAcctAP_Transaction.businessid,iPxAcctAP_Transaction.VendorID, '31 - 60 Days' as aging, iPxAcctAP_Transaction.TransID, iPxAcctAP_Transaction.TransDate,iPxAcctAP_Transaction.transactiontype, iPxAcctAP_Transaction.PVno, iPxAcctAP_Transaction.PONo, iPxAcctAP_Transaction.RRNo, (iPxAcctAP_Transaction.amountdr) ,(CASE WHEN iPxAcctAP_Transaction.TransDate <= '" & a & "' THEN iPxAcctAP_Transaction.amountcr WHEN iPxAcctAP_Transaction.TransDate > '" & a & "' THEN '0' END) "
        sSQL += "FROM iPxAcctAP_PV inner join iPxAcctAP_Transaction on iPxAcctAP_Transaction.PVno=iPxAcctAP_PV.PVNo "
        sSQL += "where iPxAcctAP_Transaction.businessid ='" & Session("sBusinessID") & "' and iPxAcctAP_Transaction.PVno <> '' and iPxAcctAP_Transaction.VendorID = '" & Session("sCustSummaryCC") & "' and iPxAcctAP_Transaction.isActive='Y' and "
        ...
        sSQL += "(CASE WHEN iPxAcctAP_PV.PVDate < '" & a & "' THEN iPxAcctAP_PV.PVDate WHEN iPxAcctAP_PV.PVDate >= '" & a & "' THEN iPxAcctAP_Transaction.TransDate END <= '" & bln1 & "') "
        sSQL += "UNION ALL "
        sSQL += "SELECT iPxAcctAP_Transaction.businessid,iPxAcctAP_Transaction.VendorID, '61 - 90 Days' as aging, iPxAcctAP_Transaction.TransID, iPxAcctAP_Transaction.TransDate,iPxAcctAP_Transaction.transactiontype, iPxAcctAP_Transaction.PVno, iPxAcctAP_Transaction.PONo, iPxAcctAP_Transaction.RRNo, (iPxAcctAP_Transaction.amountdr) ,(iPxAcctAP_Transaction.amountcr) "
        sSQL += "FROM iPxAcctAP_Transaction where businessid ='" & Session("sBusinessID") & "' and PVno ='' and VendorID = '" & Session("sCustSummaryCC") & "' and (TransDate > '" & bln3 & "') and (TransDate <= '" & bln2 & "') and isActive='Y' "
        sSQL += "UNION ALL "
        sSQL += "SELECT iPxAcctAP_Transaction.businessid,iPxAcctAP_Transaction.VendorID, '61 - 90 Days' as aging, iPxAcctAP_Transaction.TransID, iPxAcctAP_Transaction.TransDate,iPxAcctAP_Transaction.transactiontype, iPxAcctAP_Transaction.PVno, iPxAcctAP_Transaction.PONo, iPxAcctAP_Transaction.RRNo, (iPxAcctAP_Transaction.amountdr) ,(CASE WHEN iPxAcctAP_Transaction.TransDate <= '" & a & "' THEN iPxAcctAP_Transaction.amountcr WHEN iPxAcctAP_Transaction.TransDate > '" & a & "' THEN '0' END) "
        sSQL += "FROM iPxAcctAP_PV inner join iPxAcctAP_Transaction on iPxAcctAP_Transaction.PVno=iPxAcctAP_PV.PVNo "
        sSQL += "where iPxAcctAP_Transaction.businessid ='" & Session("sBusinessID") & "' and iPxAcctAP_Transaction.PVno <> '' and iPxAcctAP_Transaction.VendorID = '" & Session("sCustSummaryCC") & "' and iPxAcctAP_Transaction.isActive='Y' and "
        ...
        sSQL += "(CASE WHEN iPxAcctAP_PV.PVDate < '" & a & "' THEN iPxAcctAP_PV.PVDate WHEN iPxAcctAP_PV.PVDate >= '" & a & "' THEN iPxAcctAP_Transaction.TransDate END <= '" & bln2 & "') "
        sSQL += "UNION ALL "
        sSQL += "SELECT iPxAcctAP_Transaction.businessid,iPxAcctAP_Transaction.VendorID, '91 - 120 Days' as aging, iPxAcctAP_Transaction.TransID, iPxAcctAP_Transaction.TransDate,iPxAcctAP_Transaction.transactiontype, iPxAcctAP_Transaction.PVno, iPxAcctAP_Transaction.PONo, iPxAcctAP_Transaction.RRNo, (iPxAcctAP_Transaction.amountdr) ,(iPxAcctAP_Transaction.amountcr) "
        sSQL += "FROM iPxAcctAP_Transaction where businessid ='" & Session("sBusinessID") & "' and PVno ='' and VendorID = '" & Session("sCustSummaryCC") & "' and (TransDate > '" & bln4 & "') and (TransDate <= '" & bln3 & "') and isActive='Y' "
        sSQL += "UNION ALL "
        sSQL += "SELECT iPxAcctAP_Transaction.businessid,iPxAcctAP_Transaction.VendorID, '91 - 120 Days' as aging, iPxAcctAP_Transaction.TransID, iPxAcctAP_Transaction.TransDate,iPxAcctAP_Transaction.transactiontype, iPxAcctAP_Transaction.PVno, iPxAcctAP_Transaction.PONo, iPxAcctAP_Transaction.RRNo, (iPxAcctAP_Transaction.amountdr) ,(CASE WHEN iPxAcctAP_Transaction.TransDate <= '" & a & "' THEN iPxAcctAP_Transaction.amountcr WHEN iPxAcctAP_Transaction.TransDate > '" & a & "' THEN '0' END) "
        sSQL += "FROM iPxAcctAP_PV inner join iPxAcctAP_Transaction on iPxAcctAP_Transaction.PVno=iPxAcctAP_PV.PVNo "
        sSQL += "where iPxAcctAP_Transaction.businessid ='" & Session("sBusinessID") & "' and iPxAcctAP_Transaction.PVno <> '' and iPxAcctAP_Transaction.VendorID = '" & Session("sCustSummaryCC") & "' and iPxAcctAP_Transaction.isActive='Y' and "
        ...
        sSQL += "(CASE WHEN iPxAcctAP_PV.PVDate < '" & a & "' THEN iPxAcctAP_PV.PVDate WHEN iPxAcctAP_PV.PVDate >= '" & a & "' THEN iPxAcctAP_Transaction.TransDate END <= '" & bln3 & "') "
        sSQL += "UNION ALL "
        sSQL += "SELECT iPxAcctAP_Transaction.businessid,iPxAcctAP_Transaction.VendorID, '121 days more' as aging, iPxAcctAP_Transaction.TransID, iPxAcctAP_Transaction.TransDate,iPxAcctAP_Transaction.transactiontype, iPxAcctAP_Transaction.PVno, iPxAcctAP_Transaction.PONo, iPxAcctAP_Transaction.RRNo, (iPxAcctAP_Transaction.amountdr) ,(iPxAcctAP_Transaction.amountcr) "
        sSQL += "FROM iPxAcctAP_Transaction where businessid ='" & Session("sBusinessID") & "' and PVno ='' and VendorID = '" & Session("sCustSummaryCC") & "' and (TransDate <= '" & bln4 & "') and isActive='Y' "
        sSQL += "UNION ALL "
        sSQL += "SELECT iPxAcctAP_Transaction.businessid,iPxAcctAP_Transaction.VendorID, '121 days more' as aging, iPxAcctAP_Transaction.TransID, iPxAcctAP_Transaction.TransDate,iPxAcctAP_Transaction.transactiontype, iPxAcctAP_Transaction.PVno, iPxAcctAP_Transaction.PONo, iPxAcctAP_Transaction.RRNo, (iPxAcctAP_Transaction.amountdr) ,(CASE WHEN iPxAcctAP_Transaction.TransDate <= '" & a & "' THEN iPxAcctAP_Transaction.amountcr WHEN iPxAcctAP_Transaction.TransDate > '" & a & "' THEN '0' END) "
        sSQL += "FROM iPxAcctAP_PV inner join iPxAcctAP_Transaction on iPxAcctAP_Transaction.PVno=iPxAcctAP_PV.PVNo "
        sSQL += "where iPxAcctAP_Transaction.businessid ='" & Session("sBusinessID") & "' and iPxAcctAP_Transaction.PVno <> '' and iPxAcctAP_Transaction.VendorID = '" & Session("sCustSummaryCC") & "' and iPxAcctAP_Transaction.isActive='Y' and "
        sSQL += "(CASE WHEN iPxAcctAP_PV.PVDate < '" & a & "' THEN iPxAcctAP_PV.PVDate WHEN iPxAcctAP_PV.PVDate >= '" & a & "' THEN iPxAcctAP_Transaction.TransDate END <= '" & bln4 & "') "
        sSQL += "order by aging,iPxAcctAP_Transaction.TransDate asc "
        oSQLCmd.CommandText = sSQL
        oSQLCmd.ExecuteNonQuery()
    ...
    Sub ListDetailAging()
        ...
        End If
        oSQLCmd = New SqlCommand(sSQL, oCnct)
        sSQL = "SELECT '1' as numb, '1 - 30 Days' as aging, iPxAcctAP_Transaction.TransID, iPxAcctAP_Transaction.TransDate, VendorID,iPxAcctAP_Transaction.transactiontype, iPxAcctAP_Transaction.PVno, iPxAcctAP_Transaction.PONo, iPxAcctAP_Transaction.RRNo, (iPxAcctAP_Transaction.amountdr) ,(iPxAcctAP_Transaction.amountcr) "
        sSQL += "FROM iPxAcctAP_Transaction where businessid ='" & Session("sBusinessID") & "' and PVno ='' and VendorID = '" & Session("sCustSummaryCC") & "' and (TransDate > '" & bln1 & "') and (TransDate <= '" & a & "') and isActive='Y' "
        sSQL += "UNION ALL "
        sSQL += "SELECT '1' as numb, '1 - 30 Days' as aging, iPxAcctAP_Transaction.TransID, iPxAcctAP_Transaction.TransDate, iPxAcctAp_Transaction.VendorID,iPxAcctAP_Transaction.transactiontype, iPxAcctAP_Transaction.PVno, iPxAcctAP_Transaction.PONo, iPxAcctAP_Transaction.RRNo, (iPxAcctAP_Transaction.amountdr) ,(CASE WHEN iPxAcctAP_Transaction.TransDate <= '" & a & "' THEN iPxAcctAP_Transaction.amountcr WHEN iPxAcctAP_Transaction.TransDate > '" & a & "' THEN '0' END) "
        sSQL += "FROM iPxAcctAP_PV inner join iPxAcctAP_Transaction on iPxAcctAP_Transaction.PVno=iPxAcctAP_PV.PVNo "
        sSQL += "where iPxAcctAP_Transaction.businessid ='" & Session("sBusinessID") & "' and iPxAcctAP_Transaction.PVno <> '' and iPxAcctAP_Transaction.VendorID = '" & Session("sCustSummaryCC") & "' and iPxAcctAP_Transaction.isActive='Y' and "
        sSQL += "(CASE WHEN iPxAcctAP_PV.PVDate < '" & a & "' THEN iPxAcctAP_PV.PVDate WHEN iPxAcctAP_PV.PVDate >= '" & a & "' THEN iPxAcctAP_Transaction.TransDate END > '" & bln1 & "') and "
        sSQL += "(CASE WHEN iPxAcctAP_PV.PVDate < '" & a & "' THEN iPxAcctAP_PV.PVDate WHEN iPxAcctAP_PV.PVDate >= '" & a & "' THEN iPxAcctAP_Transaction.TransDate END <= '" & a & "') "
        sSQL += "UNION ALL "
        sSQL += "SELECT '2' as numb, '31 - 60 Days' as aging, iPxAcctAP_Transaction.TransID, iPxAcctAP_Transaction.TransDate, VendorID,iPxAcctAP_Transaction.transactiontype, iPxAcctAP_Transaction.PVno, iPxAcctAP_Transaction.PONo, iPxAcctAP_Transaction.RRNo, (iPxAcctAP_Transaction.amountdr) ,(iPxAcctAP_Transaction.amountcr) "
        sSQL += "FROM iPxAcctAP_Transaction where businessid ='" & Session("sBusinessID") & "' and PVno ='' and VendorID = '" & Session("sCustSummaryCC") & "' and (TransDate > '" & bln2 & "') and (TransDate <= '" & bln1 & "') and isActive='Y' "
        sSQL += "UNION ALL "
        sSQL += "SELECT '2' as numb, '31 - 60 Days' as aging, iPxAcctAP_Transaction.TransID, iPxAcctAP_Transaction.TransDate, iPxAcctAP_Transaction.VendorID,iPxAcctAP_Transaction.transactiontype, iPxAcctAP_Transaction.PVno, iPxAcctAP_Transaction.PONo, iPxAcctAP_Transaction.RRNo, (iPxAcctAP_Transaction.amountdr) ,(CASE WHEN iPxAcctAP_Transaction.TransDate <= '" & a & "' THEN iPxAcctAP_Transaction.amountcr WHEN iPxAcctAP_Transaction.TransDate > '" & a & "' THEN '0' END) "
        sSQL += "FROM iPxAcctAP_PV inner join iPxAcctAP_Transaction on iPxAcctAP_Transaction.PVno=iPxAcctAP_PV.PVNo "
        sSQL += "where iPxAcctAP_Transaction.businessid ='" & Session("sBusinessID") & "' and iPxAcctAP_Transaction.PVno <> '' and iPxAcctAP_Transaction.VendorID = '" & Session("sCustSummaryCC") & "' and iPxAcctAP_Transaction.isActive='Y' and "
        sSQL += "(CASE WHEN iPxAcctAP_PV.PVDate < '" & a & "' THEN iPxAcctAP_PV.PVDate WHEN iPxAcctAP_PV.PVDate >= '" & a & "' THEN iPxAcctAP_Transaction.TransDate END > '" & bln2 & "') and "
        sSQL += "(CASE WHEN iPxAcctAP_PV.PVDate < '" & a & "' THEN iPxAcctAP_PV.PVDate WHEN iPxAcctAP_PV.PVDate >= '" & a & "' THEN iPxAcctAP_Transaction.TransDate END <= '" & bln1 & "') "
        sSQL += "UNION ALL "
        sSQL += "SELECT '3' as numb, '61 - 90 Days' as aging, iPxAcctAP_Transaction.TransID, iPxAcctAP_Transaction.TransDate, VendorID,iPxAcctAP_Transaction.transactiontype, iPxAcctAP_Transaction.PVno, iPxAcctAP_Transaction.PONo, iPxAcctAP_Transaction.RRNo, (iPxAcctAP_Transaction.amountdr) ,(iPxAcctAP_Transaction.amountcr) "
        sSQL += "FROM iPxAcctAP_Transaction where businessid ='" & Session("sBusinessID") & "' and PVno ='' and VendorID = '" & Session("sCustSummaryCC") & "' and (TransDate > '" & bln3 & "') and (TransDate <= '" & bln2 & "') and isActive='Y' "
        sSQL += "UNION ALL "
        sSQL += "SELECT '3' as numb, '61 - 90 Days' as aging, iPxAcctAP_Transaction.TransID, iPxAcctAP_Transaction.TransDate, iPxAcctAP_Transaction.VendorID,iPxAcctAP_Transaction.transactiontype, iPxAcctAP_Transaction.PVno, iPxAcctAP_Transaction.PONo, iPxAcctAP_Transaction.RRNo, (iPxAcctAP_Transaction.amountdr) ,(CASE WHEN iPxAcctAP_Transaction.TransDate <= '" & a & "' THEN iPxAcctAP_Transaction.amountcr WHEN iPxAcctAP_Transaction.TransDate > '" & a & "' THEN '0' END) "
        sSQL += "FROM iPxAcctAP_PV inner join iPxAcctAP_Transaction on iPxAcctAP_Transaction.PVno=iPxAcctAP_PV.PVNo "
        sSQL += "where iPxAcctAP_Transaction.businessid ='" & Session("sBusinessID") & "' and iPxAcctAP_Transaction.PVno <> '' and iPxAcctAP_Transaction.VendorID = '" & Session("sCustSummaryCC") & "' and iPxAcctAP_Transaction.isActive='Y' and "
        sSQL += "(CASE WHEN iPxAcctAP_PV.PVDate < '" & a & "' THEN iPxAcctAP_PV.PVDate WHEN iPxAcctAP_PV.PVDate >= '" & a & "' THEN iPxAcctAP_Transaction.TransDate END > '" & bln3 & "') and "
        sSQL += "(CASE WHEN iPxAcctAP_PV.PVDate < '" & a & "' THEN iPxAcctAP_PV.PVDate WHEN iPxAcctAP_PV.PVDate >= '" & a & "' THEN iPxAcctAP_Transaction.TransDate END <= '" & bln2 & "') "
        sSQL += "UNION ALL "
        sSQL += "SELECT '4' as numb, '91 - 120 Days' as aging, iPxAcctAP_Transaction.TransID, iPxAcctAP_Transaction.TransDate, VendorID,iPxAcctAP_Transaction.transactiontype, iPxAcctAP_Transaction.PVno, iPxAcctAP_Transaction.PONo, iPxAcctAP_Transaction.RRNo, (iPxAcctAP_Transaction.amountdr) ,(iPxAcctAP_Transaction.amountcr) "
        sSQL += "FROM iPxAcctAP_Transaction where businessid ='" & Session("sBusinessID") & "' and PVno ='' and VendorID = '" & Session("sCustSummaryCC") & "' and (TransDate > '" & bln4 & "') and (TransDate <= '" & bln3 & "') and isActive='Y' "
        sSQL += "UNION ALL "
        sSQL += "SELECT '4' as numb, '91 - 120 Days' as aging, iPxAcctAP_Transaction.TransID, iPxAcctAP_Transaction.TransDate, iPxAcctAP_Transaction.VendorID,iPxAcctAP_Transaction.transactiontype, iPxAcctAP_Transaction.PVno, iPxAcctAP_Transaction.PONo, iPxAcctAP_Transaction.RRNo, (iPxAcctAP_Transaction.amountdr) ,(CASE WHEN iPxAcctAP_Transaction.TransDate <= '" & a & "' THEN iPxAcctAP_Transaction.amountcr WHEN iPxAcctAP_Transaction.TransDate > '" & a & "' THEN '0' END) "
        sSQL += "FROM iPxAcctAP_PV inner join iPxAcctAP_Transaction on iPxAcctAP_Transaction.PVno=iPxAcctAP_PV.PVNo "
        sSQL += "where iPxAcctAP_Transaction.businessid ='" & Session("sBusinessID") & "' and iPxAcctAP_Transaction.PVno <> '' and iPxAcctAP_Transaction.VendorID = '" & Session("sCustSummaryCC") & "' and iPxAcctAP_Transaction.isActive='Y' and "
        sSQL += "(CASE WHEN iPxAcctAP_PV.PVDate < '" & a & "' THEN iPxAcctAP_PV.PVDate WHEN iPxAcctAP_PV.PVDate >= '" & a & "' THEN iPxAcctAP_Transaction.TransDate END > '" & bln4 & "') and "
        sSQL += "(CASE WHEN iPxAcctAP_PV.PVDate < '" & a & "' THEN iPxAcctAP_PV.PVDate WHEN iPxAcctAP_PV.PVDate >= '" & a & "' THEN iPxAcctAP_Transaction.TransDate END <= '" & bln3 & "') "
        sSQL += "UNION ALL "
        sSQL += "SELECT '5' as numb, '121 days more' as aging, iPxAcctAP_Transaction.TransID, iPxAcctAP_Transaction.TransDate, VendorID,iPxAcctAP_Transaction.transactiontype, iPxAcctAP_Transaction.PVno, iPxAcctAP_Transaction.PONo, iPxAcctAP_Transaction.RRNo, (iPxAcctAP_Transaction.amountdr) ,(iPxAcctAP_Transaction.amountcr) "
        sSQL += "FROM iPxAcctAP_Transaction where businessid ='" & Session("sBusinessID") & "' and PVno ='' and VendorID = '" & Session("sCustSummaryCC") & "' and (TransDate <= '" & bln4 & "') and isActive='Y' "
        sSQL += "UNION ALL "
        sSQL += "SELECT '5' as numb, '121 days more' as aging, iPxAcctAP_Transaction.TransID, iPxAcctAP_Transaction.TransDate, iPxAcctAP_Transaction.VendorID,iPxAcctAP_Transaction.transactiontype, iPxAcctAP_Transaction.PVno, iPxAcctAP_Transaction.PONo, iPxAcctAP_Transaction.RRNo, (iPxAcctAP_Transaction.amountdr) ,(CASE WHEN iPxAcctAP_Transaction.TransDate <= '" & a & "' THEN iPxAcctAP_Transaction.amountcr WHEN iPxAcctAP_Transaction.TransDate > '" & a & "' THEN '0' END) "
        sSQL += "FROM iPxAcctAP_PV inner join iPxAcctAP_Transaction on iPxAcctAP_Transaction.PVno=iPxAcctAP_PV.PVNo "
        sSQL += "where iPxAcctAP_Transaction.businessid ='" & Session("sBusinessID") & "' and iPxAcctAP_Transaction.PVno <> '' and iPxAcctAP_Transaction.VendorID = '" & Session("sCustSummaryCC") & "' and iPxAcctAP_Transaction.isActive='Y' and "
        sSQL += "(CASE WHEN iPxAcctAP_PV.PVDate < '" & a & "' THEN iPxAcctAP_PV.PVDate WHEN iPxAcctAP_PV.PVDate >= '" & a & "' THEN iPxAcctAP_Transaction.TransDate END <= '" & bln4 & "') "
        sSQL += "order by numb,iPxAcctAP_Transaction.TransDate asc "
        Using sda As New SqlDataAdapter()
            oSQLCmd.CommandText = sSQL
            sda.SelectCommand = oSQLCmd
            Using dt As New DataTable()
    ...
    Protected Sub OnRowDataBound(ByVal sender As Object, ByVal e As GridViewRowEventArgs)
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            strPreviousRowID = DataBinder.Eval(e.Row.DataItem, "apGroup").ToString()
