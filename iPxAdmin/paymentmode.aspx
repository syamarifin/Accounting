<%@ Page Language="VB" AutoEventWireup="false" CodeFile="paymentmode.aspx.vb" Inherits="iPxAdmin_paymentmode" title="Alcor"%>
        ...
        <form id="form1" runat="server">
            <div class="lock-wrapper">
                <div id="round123" class="thumbnail lock-box">
                    <div class="center"> <img alt="" src="../assets/images/icon/icons8-cash-in-hand-48.png" />
                    </div>
                    <h4>Payment</h4>
                    <div class="row">
                        <div class="form-group col-md-12 col-sm-12 col-xs-12">
                            <div class="iconic-input right">
                                <label for="" class="text-muted">Voucher #</label>
