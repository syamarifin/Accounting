<%@ Page Language="VB" MasterPageFile="~/iPxAdmin/MasterPage.master" AutoEventWireup="false" CodeFile="iPxAPInputPayment.aspx.vb" Inherits="iPxAdmin_iPxAPInputPayment" title="Alcor Accounting" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="small-box">
        <div class="inner">
            <h3>AP Payment <asp:Label ID="lbRecID" runat="server" Text="ReceiptID"></asp:Label></h3>
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group" style="margin-bottom:3px;">
                        <label for="usr">Payment Date:</label><font color=red>*</font>
                        ...
                        <asp:Panel ID="pnInvoice" runat="server">
                            ...
                            <asp:GridView EmptyDataText="No records has been added." ID="gvARInv" runat="server" AutoGenerateColumns="false" CssClass="table" HeaderStyle-BackColor="#0a818e" HeaderStyle-ForeColor="White" HeaderStyle-Font-Bold="true" Font-Size="Smaller" GridLines="None" ShowFooter="true" AllowPaging="true" PageSize="10">
                                <Columns>
                                    ...
                                    <asp:TemplateField ItemStyle-Width="100px" HeaderText="Debit" ItemStyle-HorizontalAlign="Right">
                                        <ItemTemplate>
                                            <asp:Label ID="lbAPDebit" runat="server" Text='<%# if(Eval("Debit").toString()="",string.Format("{0:N2}",0),string.Format("{0:N2}",Eval("Debit"))) %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" style="left:-60px; min-width: 100px;" role="menu">
                                                    <li><asp:LinkButton ID="lbDetailInv" CssClass="btn btn-link btn_right" runat="server" CommandName="getDetailInv" CommandArgument='<%# Eval("PVNo") %>'> Voucher <i class="fa fa-file-text-o"></i></asp:LinkButton></li>
                                                    <li><asp:LinkButton ID="lbDetailRec" CssClass="btn btn-link btn_right" runat="server" CommandName="getDetailRec" CommandArgument='<%# Eval("PVNo") %>'> Payment <i class="fa fa-file-text-o"></i></asp:LinkButton></li>
                                                </ul>
                                            </div>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                            ...
                            <div class="panel-body">
                                <div class="form-group left">
                                    <asp:GridView ID="gvDetailReceipt" runat="server" AutoGenerateColumns="false" CssClass="table" FooterStyle-Font-Bold="true" HeaderStyle-BackColor="#0a818e" HeaderStyle-ForeColor="White" HeaderStyle-Font-Bold="true" Font-Size="Smaller" GridLines="None" ShowFooter="true">
                                        <Columns>
                                            <asp:BoundField ItemStyle-Width ="90px" DataField="TransID" HeaderText="Payment ID"/>
                                            ...
                                            <asp:BoundField ItemStyle-Width ="90px" DataField="PaymentDate" HeaderText="Date" DataFormatString="{0:dd MMM yyyy}"/>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <div id="footer" class="container">
        ...
        <asp:LinkButton ID="lbSaveReceipt" Width="150px" runat="server" CssClass="btn btn-default" OnClientClick = "return ConfirmDelete();"><i class="fa fa-save"></i> Save Payment</asp:LinkButton>
        <asp:LinkButton ID="lbUpdateReceipt" Width="150px" runat="server" CssClass="btn btn-default" ><i class="fa fa-save"></i> Update Payment</asp:LinkButton>
    </div>
</asp:Content>
