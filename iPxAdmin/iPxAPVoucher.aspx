<%@ Page Language="VB" MasterPageFile="~/iPxAdmin/MasterPage.master" AutoEventWireup="false" CodeFile="iPxAPVoucher.aspx.vb" Inherits="iPxAdmin_iPxAPVoucher" title="Alcor Accounting AP Voucher" %>
        ...
        <div role="document" class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header" style="background-color:Transparent;">
                    ...
                    <h4 id="H3" class="modal-title">Do you want to delete Payment Voucher ?</h4>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label for="usr">Reason to delete Payment Voucher :</label><font color=red>*</font>
        ...
        <div role="document" class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header" style="background-color:Transparent;">
                    ...
                    <h4 id="H2" class="modal-title">Send Payment Voucher To</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-12">
        ...
        <div role="document" class="modal-dialog modal-md" style="width:400px;">
            <div class="modal-content">
                <div class="modal-header" style="background-color:Transparent;">
                    ...
                    <h4 id="login-modalLabel" class="modal-title">Query Vendor</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group" style="margin-bottom:3px;">
                                <label for="usr">PV ID:</label>
                                <asp:TextBox ID="tbQInvID" runat="server" CssClass ="form-control"></asp:TextBox>
                            </div>
                            <div class="form-group" style="margin-bottom:3px;">
                                <label for="usr">PV Date:</label>
        ...
        <div role="document" class="modal-dialog modal-lg" style="width:1000px;">
            <div class="modal-content">
                <div class="modal-header" style="background-color:Transparent;">
                    ...
                    <h4 id="H1" class="modal-title">Detail Payment Voucher 
            ...
            <div id="myTabContent" class="tab-content">
                <div class="tab-pane active in" id="New">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <asp:LinkButton ID="lbAddInv" Width="150px" runat="server" CssClass="btn btn-default"><i class="fa fa-plus"></i> New PV</asp:LinkButton>
                        ...
                        <div class="col-lg-12">
                            <asp:GridView EmptyDataText="No records has been added." ID="gvARInv" runat="server" AutoGenerateColumns="false" CssClass="table" HeaderStyle-BackColor="#0a818e" HeaderStyle-ForeColor="White" HeaderStyle-Font-Bold="true" Font-Size="Smaller" GridLines="None" DataKeyNames = "PVNO" ShowFooter="true">
                                <Columns>
                                    ...
                                    <asp:BoundField ItemStyle-Width="100px" DataField="PVDate" HeaderText="Voucher Date" DataFormatString="{0:dd MMM yyyy}"/>
                                    ...
                                    <asp:TemplateField ItemStyle-Width="50px" HeaderText="Print" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lbPrint" CssClass="btn btn-default" runat="server" CommandName="getPrint" Enabled='<%# if(Eval("Status").toString()="N","true","false") %>' CommandArgument='<%# Eval("PVNo") %>'><i class="fa fa-print"></i></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField ItemStyle-Width="50px" HeaderText="Send" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lbEmail" CssClass="btn btn-default" runat="server" CommandName="getEmail" CommandArgument='<%# Eval("PVNo") %>' Enabled='<%# if(Eval("sendInv").toString()="Y","true","false") %>'><i class="fa fa-envelope"></i></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" style="left:-60px; min-width: 100px;" role="menu">
                                                    <li><asp:LinkButton ID="lbDetail" CssClass="btn btn-link btn_right" runat="server" CommandName="getDetail" CommandArgument='<%# Eval("PVNo") %>'> Detail <i class="fa fa-file-text-o"></i></asp:LinkButton></li>
                                                    <li><asp:LinkButton ID="lbEdit" CssClass="btn btn-link btn_right" runat="server" CommandName="getEdit" Enabled='<%# if(Eval("Status").toString()="N",if(Eval("editInv").toString()="Y","true","false"),"false") %>' CommandArgument='<%# Eval("PVNo") %>'> Edit <i class="fa fa-edit"></i></asp:LinkButton></li>
                                                    <li><asp:LinkButton ID="lbDelete" CssClass="btn btn-link btn_right" runat="server" OnClientClick="return confirmationDel();" CommandName="getDelete" Enabled='<%# if(Eval("Status").toString()="N",if(Eval("deleteInv").toString()="Y","true","false"),"false") %>' CommandArgument='<%# Eval("PVNo") %>'> Delete <i class="fa fa-trash"></i></asp:LinkButton></li>
                                                </ul>
                                            </div>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                ...
                <div class="tab-pane" id="Approve">
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <asp:GridView EmptyDataText="No records has been added." ID="gvApprove" runat="server" AutoGenerateColumns="false" CssClass="table" HeaderStyle-BackColor="#0a818e" HeaderStyle-ForeColor="White" HeaderStyle-Font-Bold="true" Font-Size="Smaller" GridLines="None" DataKeyNames = "PVNO" ShowFooter="true">
                                <Columns>
                                    <asp:TemplateField ItemStyle-Width="20px">
                                        <HeaderTemplate>
                                            <asp:CheckBox ID="chkAll" runat="server" onclick = "checkAll(this);" />
                                    ...
                                    <asp:TemplateField ItemStyle-Width="50px" HeaderText="Detail" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lbDetail" CssClass="btn btn-default" runat="server" CommandName="getDetail" CommandArgument='<%# Eval("PVNo") %>'><i class="fa fa-file-text-o"></i></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <%--<asp:TemplateField ItemStyle-Width="50px" HeaderText="Edit" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField ItemStyle-Width="50px" HeaderText="Print" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lbPrint" CssClass="btn btn-default" runat="server" CommandName="getPrint" CommandArgument='<%# Eval("PVNo") %>'><i class="fa fa-print"></i></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField ItemStyle-Width="50px" HeaderText="Send" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                ...
                <div class="tab-pane" id="Paid">
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <asp:GridView EmptyDataText="No records has been added." ID="gvPaid" runat="server" AutoGenerateColumns="false" CssClass="table" HeaderStyle-BackColor="#0a818e" HeaderStyle-ForeColor="White" HeaderStyle-Font-Bold="true" Font-Size="Smaller" GridLines="None" DataKeyNames = "PVNo" ShowFooter="true">
                                <Columns>
                                    <asp:BoundField ItemStyle-Width="100px" DataField="PVNo" HeaderText="Voucher No" />
                                    <asp:BoundField ItemStyle-Width="100px" DataField="PVDate" HeaderText="Voucher Date" DataFormatString="{0:dd MMM yyyy}"/>
                                    <asp:BoundField ItemStyle-Width="100px" DataField="DueDate" HeaderText="Due Date" DataFormatString="{0:dd MMM yyyy}"/>
