...
Partial Class iPXADMIN_iPxReportSetup
    ...
    Sub reportGRp()
        Dim cmd As New SqlCommand("SELECT  * FROM iPx_cfg_ReportGRP where moduleID='" & ddlModul.Text.Trim & "' ")
    ...
    Public Sub grid()
        ...
        Dim cmd As SqlDataAdapter = New SqlDataAdapter("Select reportID,description,reportname From iPx_cfg_ReportList where moduleID='" & ddlModul.Text.Trim & "' ", cn)
    ...
    Public Sub showData()
        ...
        Cmd = New SqlCommand("Select *From iPx_cfg_ReportList where reportid='" & txtReportID.Text & "' and moduleID='" & ddlModul.Text.Trim & "'", cn)
    ...
    Public Sub saveData()
        ...
        Cmd = New SqlCommand("insert into iPx_cfg_ReportList (moduleID,groupID,reportID,subgroupid,description,reportname,reportfile,component,prm1type,prm1label,prm1query,prm2type,prm2label,prm2query,prm3type,prm3label,prm3query,prm4type,prm4label,prm4query,Active)values ('" & ddlModul.Text & "','" & ddlGrpID.Text & "','" & txtReportID.Text & "','','" & txtDescription.Text & "','" & fileName & "','" & fileName & "','','" & ddlp1.Text & "','" & txtp1.Text & "','" & txtQueryP1.Text & "','" & ddlp2.Text & "','" & txtp2.Text & "','" & txtQueryP2.Text & "','" & ddlp3.Text & "','" & txtp3.Text & "','" & txtQueryP3.Text & "','" & ddlp4.Text & "','" & txtp4.Text & "','" & txtQueryP4.Text & "','" & cek & "') ", cn)
        Cmd.ExecuteNonQuery()
    ...
    Public Sub delete()
        ...
        Cmd = New SqlCommand("Delete from iPx_cfg_ReportList Where  reportid='" & txtReportID.Text & "' and moduleID='" & ddlModul.Text.Trim & "'", cn)
        Cmd.ExecuteNonQuery()
