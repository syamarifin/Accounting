<%@ Page Language="VB" MasterPageFile="~/iPxDashboard/iPxDashboard.master" EnableEventValidation="false" AutoEventWireup="false" CodeFile="viewReject.aspx.vb" Inherits="iPxDashboard_viewReject" title="Alcor Dashboard" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <div class="col-sm-12">
           ...
           <Columns>
               ...
               <asp:BoundField DataField="website" HeaderText="Website" 
                  ...
                  <%--<asp:templatefield HeaderText="Approve">
                    ...
                    <itemtemplate>
                        <asp:linkbutton width="50px" cssclass="btn btn-warning " data- id="showmbr2" CommandName="getcodeRjc" CommandArgument='<%# Eval("email") %>' runat="server"><span class="fa fa-close"></span></asp:linkbutton>
                        </itemtemplate>
                    </asp:templatefield>--%>
    ...
    <asp:LinkButton Width="150px" CssClass ="btn  btn-default" data- id="btnAbort" runat="server"><span class="fa fa-close""></span> Abort</asp:LinkButton>
