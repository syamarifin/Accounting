<%@ Page Title="Alcor Accounting" Language="VB" MasterPageFile="~/iPxDashboard/iPxDashboardUpload.master" AutoEventWireup="false" CodeFile="iPxReportSetup.aspx.vb" Inherits="iPxAdmin_iPxReportSetup" %>
    ...
    <asp:Panel ID="pnlHotelProperty" runat="server">
        ...
        <div>
            <asp:DropDownList ID="ddlModul" AutoPostBack="true" runat="server" CssClass="form-control" Width="500px" >
                ...
                <asp:ListItem Value="02">ALCOR ACCOUNTING</asp:ListItem>
            </asp:DropDownList>
        </div>
        <div>
            Report Group
